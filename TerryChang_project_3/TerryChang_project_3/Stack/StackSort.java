...
public class StackSort {
    public static VectorStack<Integer> lowerValues = new VectorStack<Integer>();
    public static VectorStack<Integer> upperValues = new VectorStack<Integer>();
    ...
    // ADD CODE HERE TO SORT THE ARRAY USING TWO STACKS
        ...
        for(int i = 0; !upperValues.isEmpty(); i++){
